...
from app.models.home_model import get_pie_ide_by_bedrooms, get_pie_ide_by_district, get_home_cards, get_sct1, get_map_markers
...
def index():
    ...
    return render_template("pages/home/inicio.html", pie1=pie1, bars1=bars1, cards=cards, sct1=sct1, map_markers=map_markers)
